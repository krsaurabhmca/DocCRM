...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($id > 0) {
        $sql = "UPDATE followups SET patient_id=$patient_id, followup_date='$followup_date', followup_type='$followup_type', status='$status', notes='$notes' WHERE id=$id";
    } else {
        $sql = "INSERT INTO followups (patient_id, followup_date, followup_type, status, notes) VALUES ($patient_id, '$followup_date', '$followup_type', '$status', '$notes')";
    }
